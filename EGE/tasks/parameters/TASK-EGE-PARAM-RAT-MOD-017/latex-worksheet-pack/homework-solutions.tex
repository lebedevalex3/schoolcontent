...
\begin{teacheranswer}[Числитель]
  ...
  \[
    ...
    x_2=-\frac{a+2}{4}.
  \]
  Уравнение числителя имеет два различных корня при \(a>-2\).
\end{teacheranswer}
...
\begin{criterionbox}
  Значение \(a=2\) получается при проверке обоих найденных значений \(x\),
  но из итогового множества исключается только один раз.
\end{criterionbox}
