...
\packtitle{Скрытый треугольник и окружность}{Учебный маршрут к одной геометрической задаче}
\studentnameblock
...
\begin{routebox}
В решении предстоит открыть две скрытые конструкции:
\[
\begin{aligned}
\text{трапеция}
&\longrightarrow
\text{треугольник и средняя линия}\\
&\longrightarrow
...
\end{aligned}
\]
После этого каждый из двух искомых углов будет найден в отдельном
...
\begin{trainingtask}[A. Скрытый треугольник]
...
\begin{trainingtask}[B. Как распознать среднюю линию]
...
\begin{attentionbox}[Логическая дисциплина]
Одного условия \(AM\perp BN\) недостаточно. Чтобы назвать \(AM\)
серединным перпендикуляром, необходимо также знать, что \(A\) — середина
отрезка \(BN\).
\end{attentionbox}
