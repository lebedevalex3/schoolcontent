...
build_fragment 14 "$source_dir/variants-13-18.tex" 'figTangentPair'
build_fragment 15 "$source_dir/variants-13-18.tex" 'figCyclicChord'
build_fragment 16 "$source_dir/variants-13-18.tex" 'figCyclicOpposite'
...
build_fragment 28 "$source_dir/variants-25-30.tex" 'figTrapezoidParallel{41}'
