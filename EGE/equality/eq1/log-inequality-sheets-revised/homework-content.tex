...
\newpage
\begin{homeworktask}[Полное решение с опорой]{4}
  Решите неравенство
  \[
  ...
  \begin{hintbox}[Контрольные ориентиры]
    Используйте \(y=\log_2|x-1|\). После решения алгебраического ядра
    получится \(y\le-2\) или \(y\ge2\), а затем
    \[
      0<|x-1|\le\frac14
      \quad\text{или}\quad
      |x-1|\ge4.
...
\begin{homeworktask}[Выберите корректную замену]{5}
  Для выражения
  \[
...
\newpage
\begin{homeworktask}[Самостоятельное решение]{6}
  Решите неравенство
  \[
...
\newpage
\begin{homeworktask}[Обобщение]{7}
