...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{
    ...
    \midrule
    Главный результат
      & Ученик разделяет исследование на два слоя: количество нулей
        числителя и допустимость каждого нуля для исходной дроби. \\
    \addlinespace[0.25em]
    ...
    \addlinespace[0.25em]
    Рекомендуемое время
      & 45--60 минут для основного маршрута; графический и третий методы
        можно перенести на продолжение или дать сильной группе. \\
    \bottomrule
  \end{tabularx}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{
    ...
    \midrule
    5 мин & Ноль дроби
      & Достаточно ли обнулить числитель?
      & Нет; знаменатель при том же \(x\) должен быть ненулевым. \\
    \addlinespace[0.2em]
    12 мин & Числитель
    ...
    \addlinespace[0.2em]
    8 мин & Рефлексия
      & Что показывает график, а чего он не показывает?
      & График даёт число нулей числителя, но не учитывает знаменатель. \\
    \bottomrule
  \end{tabularx}
\end{center}
...
Оба нуля существуют на своих ветвях при \(a>-2\). При \(a=-2\) обе
...
\begin{warningbox}
  ...
  определения исходной дроби, поэтому значения \(-1,0,3,8\) на нём не
  обнаруживаются.
\end{warningbox}
...
\begin{propertybox}[Задание 2]
  Условие \(a>-2\) не является ложным: оно правильно описывает количество
  нулей числителя. Решение неполно, потому что не проверено, являются ли эти
  нули допустимыми для исходной дроби.
\end{propertybox}
...
\begin{questionsbox}
  ...
  \begin{minipage}[t]{0.485\linewidth}
    \begin{itemize}[itemsep=0.18em,topsep=0.15em]
      \item проверяет оба кандидата в знаменателе;
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{
    ...
    \addlinespace[0.2em]
    Проверка двух кандидатов в знаменателе
