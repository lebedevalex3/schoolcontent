...
> Статус: исторический черновик. Актуальная реализованная система описана в
> [[CONTENT_SYSTEM]]; входные карты находятся в [[EGE/00_INDEX]] и
> [[school/00_INDEX]]. Этот документ сохранён как история проектных решений.
