...
Делить запись числа справа налево на классы, называть классы единиц,
тысяч и миллионов, различать группу класса и количество его единиц,
восстанавливать число по описанию классов.

## Предварительное условие

Пройдена проверочная работа M02: ученик сохраняет нулевые разряды при записи
числа.
