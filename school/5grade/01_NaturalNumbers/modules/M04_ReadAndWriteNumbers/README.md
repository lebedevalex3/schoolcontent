...
Читать многозначные числа, правильно согласовывать названия классов,
записывать числа цифрами, сохранять нулевые классы и три позиции внутри групп.

## Предварительное условие

Пройдена проверочная работа M03: ученик делит запись числа справа налево на
