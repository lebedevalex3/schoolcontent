...
Объяснять роль нуля в позиционной записи, раскладывать число на
разрядные слагаемые и восстанавливать число обратно.

## Предварительное условие

Пройдена проверочная работа M01: ученик определяет разряд и значение цифры.
