...
## Результат (ученик научится)

Точно читать условие переборной задачи, строить полный упорядоченный
список чисел, учитывать повторения, обязательность цифр и запрет нуля в начале
записи, обнаруживать пропуски и повторы.
...
проверочной работе, а объём практики выбирается по устойчивости способа.
...
Ученик выполняет обязательное ядро и проверочную работу. При случайном или
